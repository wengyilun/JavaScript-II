...
ticketPriceTotal = runners.reduce(function(subtotal, currentValue){
    return subtotal + currentValue.donation
},0)
...
runners.filter(function(currentValue){
    return currentValue.company_name === 'Skinix' && currentValue.donation > 150
}).map(function(currentValue){
    currentValue.donation //?
    return currentValue.donation
}).reduce(function(subtotal, currentValue){
